      ...
      <div className="flex flex-col space-y-1.5 w-full">
        <label htmlFor="avail-date-input" className="text-[11px] font-extrabold text-neutral-705 dark:text-stone-300 tracking-tight pl-0.5 select-none flex items-center justify-between">
          <span className="flex items-center gap-1.5">
            <Calendar className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-450 stroke-[2]" />
            Availability Date <span className="text-emerald-500 dark:text-emerald-450">*</span>
          </span>
          <span className="text-[9.5px] font-mono text-neutral-400 uppercase tracking-widest font-black">Step 1 of 4</span>
        </label>

        <p className="text-[10px] font-bold text-neutral-400 dark:text-stone-500 pb-1">
          When will the vacant house be ready for the new renter to move in?
        </p>

        <div className="relative flex items-center">
          {/* Custom Calendar Icon overlay  */}
          <Calendar className="absolute left-4 w-4.5 h-4.5 text-emerald-600 dark:text-emerald-500 pointer-events-none stroke-[2]" />
          ...
          <input
            ...
            className={`w-full h-12 pl-12 pr-10 bg-white/50 dark:bg-stone-850/40 rounded-2xl border text-xs font-black text-neutral-800 dark:text-neutral-105 tracking-tight uppercase placeholder-neutral-400 focus:outline-hidden focus:ring-2 focus:bg-white dark:focus:bg-stone-900 transition-all cursor-pointer ${
              error
