...
export default function TestModeHeader({ onBack }: TestModeHeaderProps) {
  return (
    <motion.header
    ...
    >
      <div className="flex items-center justify-between px-4 h-14 max-w-lg mx-auto">
        ...
        <div className="w-10 h-10 flex items-center justify-center rounded-full bg-indigo-50 dark:bg-indigo-950/20 text-indigo-600 dark:text-indigo-400" aria-hidden="true">
