      ...
      <div>
        ...
        <div className="w-full h-44 rounded-xl overflow-hidden relative mb-2.5 bg-neutral-100 dark:bg-stone-900">
          ...
          <motion.button
            ...
            className="absolute top-2.5 right-2.5 z-10 w-10 h-10 rounded-full bg-white/95 dark:bg-stone-800/95 flex items-center justify-center shadow-xs text-neutral-800 dark:text-neutral-150 outline-none cursor-pointer border-none"
      ...
      >
        ...
        {hasPhone ? (
          <motion.a
            ...
            className="flex items-center justify-center space-x-1 h-10 rounded-lg border border-emerald-500 dark:border-emerald-600 text-emerald-700 dark:text-emerald-400 bg-white dark:bg-transparent hover:bg-emerald-50/40 dark:hover:bg-emerald-950/20 text-[11px] font-bold transition-colors shadow-2xs outline-none"
          >
          ...
          <button
            disabled
            className="flex items-center justify-center space-x-1 h-10 rounded-lg border border-neutral-200 dark:border-stone-700 text-neutral-400 dark:text-stone-600 text-[11px] font-bold cursor-not-allowed"
        ...
        {hasWhatsapp ? (
          <motion.a
            ...
            className="flex items-center justify-center space-x-1 h-10 rounded-lg bg-emerald-600 dark:bg-emerald-600 text-white hover:bg-emerald-700 dark:hover:bg-emerald-500 text-[11px] font-bold transition-colors shadow-2xs outline-none border-none"
          >
          ...
          <button
            disabled
            className="flex items-center justify-center space-x-1 h-10 rounded-lg bg-neutral-100 dark:bg-stone-850 text-neutral-400 dark:text-stone-600 text-[11px] font-bold cursor-not-allowed"
