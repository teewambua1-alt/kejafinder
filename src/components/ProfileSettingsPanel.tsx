...
const PANEL_TITLES: Record<ProfileSettingsPanelType, string> = {
  settings_home: 'Settings',
  personal_details: 'Personal details',
  help_center: 'Help center',
  logout: 'Log out',
  about_page: 'About KejaFinder',
};
        ...
        return (
          <div className="space-y-4">
                ...
                return (
                  ...
                  >
                    <div className="w-8.5 h-8.5 rounded-xl bg-emerald-50/80 dark:bg-emerald-950/25 border border-emerald-100/50 dark:border-emerald-900/40 flex items-center justify-center shrink-0">
                      <Icon className="w-4 h-4 text-emerald-700 dark:text-emerald-400 stroke-[2.2]" />
                    </div>
                    ...
                    <ChevronRight className="w-4 h-4 text-neutral-550 dark:text-stone-400" />
                  </button>
                );
              })}
            </div>
            ...
            <button
              ...
              className="w-full mt-2 p-3.5 flex items-center justify-center space-x-2 text-center border border-dashed border-orange-200 dark:border-orange-950/30 hover:border-orange-550/35 bg-white dark:bg-stone-900 rounded-2.5xl transition-all cursor-pointer text-orange-700 dark:text-orange-400 outline-none"
            >
        ...
        return (
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-[10px] font-bold text-neutral-550 dark:text-stone-400 uppercase tracking-wider">Configure your contact card</p>
            </div>
      ...
      case 'logout':
        return (
          <div className="space-y-4 text-center py-4">
            ...
            <div className="w-14 h-14 rounded-full bg-orange-100 dark:bg-orange-950/20 flex items-center justify-center mx-auto mb-3 text-orange-700 dark:text-orange-400 border border-orange-200">
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-2.5 max-w-sm mx-auto">
              ...
              <button
                ...
                className="flex-1 py-3 text-xs font-black uppercase tracking-wider rounded-xl bg-orange-700 text-white hover:bg-orange-800 transition-all cursor-pointer outline-none"
              >
                Log Out
              </button>
            </div>
      ...
      leading={
        type !== 'settings_home' && onTypeChange ? (
          <button
            ...
            className="w-9 h-9 shrink-0 rounded-xl bg-neutral-50 dark:bg-stone-850 border border-neutral-150/50 dark:border-stone-805 flex items-center justify-center text-neutral-550 hover:text-neutral-800 dark:text-stone-400 dark:hover:text-stone-200 transition-colors outline-none cursor-pointer"
      ...
      footer={
        type !== 'logout' ? (
          <div className="flex items-center space-x-2">
            <button
              onClick={onClose}
              className="flex-1 py-3 text-[11px] font-black uppercase tracking-wider rounded-xl border border-neutral-200 dark:border-stone-850 text-neutral-550 dark:text-stone-450 hover:bg-neutral-50 dark:hover:bg-stone-850 transition-colors cursor-pointer outline-none"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 py-3 text-[11px] font-black uppercase tracking-wider rounded-xl bg-emerald-700 text-white hover:bg-emerald-800 shadow-sm shadow-emerald-500/20 transition-colors cursor-pointer outline-none disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSavingDetails ? 'Saving…' : 'Done'}
            </button>
          </div>
        ) : undefined
      }
