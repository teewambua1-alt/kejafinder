      ...
      <div className="flex flex-col space-y-1.5 w-full">
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="description-input" className="text-[11px] font-extrabold text-neutral-705 dark:text-stone-300 tracking-tight pl-0.5 select-none flex items-center gap-1.5">
            <AlignLeft className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-450 stroke-[2]" />
            Description
          </label>
          <span className="text-[9.5px] font-mono font-extrabold text-neutral-400 dark:text-stone-500">
        ...
        <div className="relative">
          <textarea
            ...
            rows={4}
            className="w-full p-4 bg-white/50 dark:bg-stone-850/40 rounded-2xl border border-neutral-100 dark:border-neutral-800/80 text-xs font-semibold text-neutral-800 dark:text-neutral-150 leading-relaxed placeholder-neutral-400 dark:placeholder-stone-600 focus:outline-hidden focus:ring-2 focus:border-emerald-500/80 focus:ring-emerald-500/20 focus:bg-white dark:focus:bg-stone-900 transition-all resize-none"
          />
        </div>

        {/* Informative Hint */}
        <p className="text-[10px] font-bold text-neutral-400 dark:text-stone-500 pl-0.5 leading-relaxed">
