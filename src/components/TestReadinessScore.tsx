...
export default function TestReadinessScore({ items }: TestReadinessScoreProps) {
  ...
  if (score >= 80) {
    ...
    colorClass = "text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30 border-emerald-100 dark:border-emerald-900/50";
  } else if (score >= 60) {
    labelText = "Good prototype, needs fixes";
    colorClass = "text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/30 border-orange-100 dark:border-orange-900/50";
  } else {
