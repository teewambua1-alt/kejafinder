  ...
  return (
    <form onSubmit={handleSubmit} className="w-full relative">
      <div className="relative flex items-center bg-white/95 dark:bg-stone-880/90 backdrop-blur-md rounded-2.5xl border border-neutral-100/90 dark:border-neutral-800/80 shadow-xs focus-within:border-emerald-500/50 focus-within:shadow-md transition-all p-1.5 pl-4">
        ...
        <Search className="w-5 h-5 text-neutral-400 dark:text-stone-500 shrink-0 mr-2.5 stroke-[2]" />
        ...
        <input
          ...
          className="w-full bg-transparent text-[13.5px] text-neutral-800 dark:text-neutral-100 placeholder-neutral-400 dark:placeholder-stone-550 outline-none pr-12 py-2.5 font-medium font-sans"
        />
        ...
        <button
          ...
          className="absolute right-2 p-2.5 rounded-xl bg-neutral-50 dark:bg-stone-800 text-neutral-500 dark:text-stone-400 hover:text-emerald-600 dark:hover:text-emerald-400 active:scale-95 transition-all outline-none cursor-pointer"
